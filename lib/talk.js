 ...
 * @param callback  function to execute with the resulting data
 */
exports.latest = function(dburl, pageNumber, quantity, callback) {
    "use strict";

    var sort = {created: -1};

    return searchTalks(dburl, {}, sort, pageNumber, quantity, callback);
};
 ...
 * @param callback  function to execute with the resulting data
 */
exports.popular = function(dburl, pageNumber, quantity, callback) {
    "use strict";
    ...
    return searchTalks(dburl, conds, sort, pageNumber, quantity, callback);
};


function searchTalks(dburl, conds, sort, pageNumber, quantity, callback) {
