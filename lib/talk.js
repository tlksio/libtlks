 ...
 * @param callback  function to execute with the resulting data
 */
exports.latest = function(dburl, quantity, callback, pageNumber) {
    "use strict";

    var sort = {created: -1};

    return searchTalks(dburl, {}, sort, quantity, callback, pageNumber);
};
 ...
 * @param callback  function to execute with the resulting data
 */
exports.popular = function(dburl, quantity, callback, pageNumber) {
    "use strict";
    ...
    return searchTalks(dburl, conds, sort, quantity, callback, pageNumber);
};


function searchTalks(dburl, conds, sort, quantity, callback, pageNumber) {
 ...
 * @param callback  function to execute with the resulting data
 */
exports.getByTag = function(dburl, tag, callback, pageNumber) {
    "use strict";

    var conds = {tags: tag};
    var sort = {viewCount: -1};
    var quantity = 10;
